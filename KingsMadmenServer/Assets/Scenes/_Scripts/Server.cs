...
public class Server
{
    ...
    private static void InitializeServerData()
    {
        ...
        packetHandlers = new Dictionary<int, PacketHandler>()
        {
            ...
            { (int)ClientPackets.playerShield, ServerHandle.PlayerShield },
            { (int)ClientPackets.playerTeleportation, ServerHandle.PlayerTeleportation },
            { (int)ClientPackets.playerPutGlyphe, ServerHandle.PlayerPutGlyphe }
        };
